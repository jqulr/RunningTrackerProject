...
class RunningLogTest {
    ...
    public void testConstructor() {
        ...
        assertEquals(testLog.getMarch(), testLog.selectMonth(Month.MAR));
        assertEquals(testLog.getApril(), testLog.selectMonth(Month.APR));
        assertEquals(testLog.getMay(), testLog.selectMonth(Month.MAY));
        assertEquals(testLog.getJune(), testLog.selectMonth(Month.JUN));
        assertEquals(testLog.getJuly(), testLog.selectMonth(Month.JUL));
        assertEquals(testLog.getAugust(), testLog.selectMonth(Month.AUG));
        assertEquals(testLog.getSeptember(), testLog.selectMonth(Month.SEP));
